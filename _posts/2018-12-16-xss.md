...
date: 2018-12-18 10:28:24.000000000 +08:00
---
...
[xss](https://www.youtube.com/watch?v=swVlFwuwJAo)
...
![svg]({{ "(http://c1h2e1.oss-cn-qingdao.aliyuncs.com/image/xss/svg.png"}}|svg)
...
+	图片后缀修改
[xss1](https://www.amolbaikar.com/xss-on-facebooks-acquisition-oculus-cdn/)


#	XSSfuzzer
GitHub地址`https://github.com/NytroRST/XSSFuzzer`
我们在本地搭建一个![xss-fuzzer]({{ "(http://c1h2e1.oss-cn-qingdao.aliyuncs.com/image/xss/xss-fuzzer.png"}}|fuzzer)
